<template>
  <div id="application">
    <section class="tareas">
      ...
      <button class="addTask button" @click="addTask">
        <img src="./assets/mas.png" alt="Agregar tarea" style="width:25px;">
      </button>
    </section>
        ...
        <ul>
          <li v-for="(task, key) in tasks" :key="key">
            ...
            <button class="deleteTask button" @click="deleteTask">
              <img src="./assets/borrar.png" alt="Borrar tarea" style="width:25px;">
            </button>
          </li>
        </ul>
      </div>
    ...
    <section v-else class="no_tareas">
      <h2>No hay tarreas por el momento</h2>
    </section>
  </div>
